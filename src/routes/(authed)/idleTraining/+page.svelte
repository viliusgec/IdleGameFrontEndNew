		...
		<div class="flex w-full">
			...
			<div class="flex flex-col w-full lg:flex-row">
				<div class="grid flex-grow h-32 card bg-base-300 rounded-box place-items-center">
					<span class="align-bottom flex items-center tooltip tooltip-bottom" data-tip="You can start idle training by clicking START button. You will receive XP after you press STOP on active training. You can receive up to 24 hours worth of XP.">
						<p class="text-3xl font-bold">Idle Training </p>
						<svg class="w-6 h-6 ml-2" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
							  fill-rule="evenodd"
							  clip-rule="evenodd"
