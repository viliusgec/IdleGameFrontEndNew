<script lang="ts">
	import { cancelListing, type MarketItem } from '../../../stores/marketStore';

	export let playerItems: MarketItem[];
			...
			<tbody>
				{#each playerItems as playerItem}
					<tr>
						...
						<th>
							<button class="btn btn-ghost btn-xs" on:click={() => cancelListing(playerItem, token)}
