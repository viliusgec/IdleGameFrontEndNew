<script lang="ts">
	...
	playerData.subscribe((value) => {money = value.money;
...
>
	...
	>
		<div class="flex items-center flex-shrink-0 text-gray-800 mr-16">
			<span class="font-semibold text-xl tracking-tight">Shit game</span>
		</div>
	...
	<div class="menu w-full flex-grow lg:flex lg:items-center lg:w-auto lg:px-3 px-8">
		<div class="text-md font-bold text-blue-200 lg:flex-grow">
			<a
			href="/"
			class="block mt-4 uppercase lg:inline-block lg:mt-0 hover:text-yellow-300 px-4 py-2 rounded hover:bg-blue-700 mr-2"
		>
			{username} : {money}
		</a>
			<a
